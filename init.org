...
- [[#org-mode][Org Mode]]
  ...
  - [[#org-clock-watch][org-clock-watch]]
  - [[#org-fc][org-fc]]
...
(transient-define-prefix notes-leader-map()
  ...
  [["Roam"
   ...
   ["org-mind-map"
    ...
    ("p" "org-plantuml" plantuml-org-to-mindmap)
    ("P" "org-plantuml-open" plantuml-org-to-mindmap-open)
    ]
   ]
  )
#+end_src
...
(setup treesit-auto
  (setq treesit-auto-install t
        treesit-auto-langs '(python c cpp json org verilog))
  (:defer
...
** org-clock-watch
#+begin_src elisp
(setup org-clock-watch
  (require 'org-clock-watch)
  (setq org-clock-watch-work-plan-file-path (concat nowis-gtd-dir "/action.org")
        org-clock-watch-play-sound-command-str "mpv"
        )
  (add-hook 'org-agenda-mode-hook (lambda()
                                    (if (not (featurep 'org-clock-watch))
                                        (require 'org-clock-watch))
