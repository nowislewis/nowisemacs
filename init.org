...
(setup embark
  ...
  (:autoload-this #'embark-toggle-highlight)
...
#+begin_src elisp
(setup imenu-list
  (:autoload-this #'imenu-list-smart-toggle)
...
(setup xref
  ...
  ;; (:autoload-this #'xref-push-marker-stack nil t)
  (require 'xref)
...
(setup eglot
  ...
  (:autoload-this #'eglot-find-implementation)
...
#+begin_src elisp
(setup org-inc
  (:autoload-this #'org-inc-continue)
...
#+begin_src elisp
(setup doc-capture
  (:autoload-this #'doc-capture-process)
...
(setup gptel
  ...
  (:when-loaded
    ...
    (gptel-make-openai "momenta"
      ...
      :key 'gptel-api-key
      :stream t
      :models '(claude-sonnet-4.5 claude-haiku-4.5 minimax-m2.1 gpt-5.2 gemini-3-pro deepseek-v3.2))
...
(setup gptel-quick
  (setq gptel-quick-timeout 40
        gptel-quick-system-message (lambda (count)
                                     (format "用小于%d 个字的中文解释." count))
        )
  (keymap-global-set "M-l" #'gptel-quick)
  (with-eval-after-load 'embark
...
(setup uniline-transient
  (:autoload-this #'uniline-mode)
  (:autoload-this #'uniline-launch-interface)
  )
#+end_src
** excalidraw
#+begin_src elisp
