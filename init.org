...
#+begin_src elisp
  ...
  (setup citar
    (:option org-cite-global-bibliography '("~/Documents/emacs/orgmode/office-documents/bibliography/better_zotero_bib.bib")
...
#+begin_src elisp
  ...
  (defun lewis-create-excalidraw()
    ...
    (let* ((filename (concat (car (split-string (buffer-name) "\\.")) ".excalidraw"))
           (path (concat nowisemacs-doc-org-mode-dir "/office-documents/excalidraw/" filename))
