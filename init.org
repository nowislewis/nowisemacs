...
(setup mini-echo
  ...
  (setq mini-echo-persistent-rule
        '(:long
          ("major-mode" "vcs" "time" "flymake" "process"
           "narrow"  "profiler" "repeat" "buffer-size" "buffer-position" "buffer-percent" "shrink-path"  "meow" "macro")
  ...
  (:when-loaded
    ...
    (mini-echo-mode)
    ;; org-priority 内部使用 read-char-exclusive 等待输入期间，
    (add-to-list 'mini-echo-skip-update-functions 'org-priority)
    ))
#+end_src
** modeline
#+begin_src elisp
