...
#+begin_src elisp
  ...
  (defun set-completion-functions ()
    (cl-concatenate completion-at-point-functions completion-at-point-functions-backup
                                                     (mapcar #'cape-company-to-capf company-backends)))
  ...
  ;;       (progn
  ;;         (setq completion-at-point-functions (remove (cape-company-to-capf #'company-english-helper-search) completion-at-point-functions))
  ...
  ;;         (add-to-list 'completion-at-point-functions (cape-company-to-capf #'company-english-helper-search))
