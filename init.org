...
(defmacro nowis-create-agenda-command (key description tag)
  `(list ,key ,description
         '((agenda ""
           ...
           (tags-todo ,(concat "+PRIORITY=\"A\"" tag)
...
(setup gptel
  ...
  (:when-loaded
    ...
    (gptel-make-openai "momenta"
      ...
      :key 'gptel-api-key
      :stream t
      :models '(us.anthropic.claude-3-7-sonnet-20250219-v1:0 azure/gpt-4.1 gemini/gemini-2.5-pro-preview-03-25 gemini-2.5-flash-preview-04-17))
