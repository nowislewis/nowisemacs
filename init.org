...
*** rsync
#+begin_src elisp
  (defun rsync-backup-papers()
    "back paper files in emacs"
    (interactive)
    (shell-command "rsync -anvh ~/Documents/emacs/orgmode/papers/ ~/Documents/backup" "rsync-backup-papers"))
#+end_src
** no-littering
#+begin_src lisp
  (setup no-littering)
...
#+begin_src elisp
  ...
  (setup citar
    (:option org-cite-global-bibliography '("~/Documents/emacs/orgmode/other-texts/bibliography/better_zotero_bib.bib")
...
#+begin_src elisp
  ...
  (defun lewis-create-excalidraw()
    ...
    (let* ((filename (concat (car (split-string (buffer-name) "\\.")) ".excalidraw"))
           (path (concat nowisemacs-doc-org-mode-dir "/other-texts/excalidraw/" filename))
