...
(transient-define-prefix dictionary-leader-map()
  ...
  [["dictionary-overlay"
   ...
   ("t" "render-toggle" dictionary-overlay-toggle)
...
(setup dictionary-overlay
  ...
  (setq dictionary-overlay-translators '("sdcv" "darwin" "web")
        dictionary-overlay-lookup-with #'gt-quick-sdcv
        dictionary-overlay-user-data-directory (concat nowis-doc-emacs-dir "12-dictionary-overlay")
