...
(setup org-sm
  ...
  (:when-loaded
    ;; AI acts on existing cards only -- capture stays raw.  Inside the card
    ;; workbench ("A" below): C-c C-a = AI refine + split off child cards,
    ;; C-c C-i = AI refine the text at point, C-c C-c = commit.
  ...
  (transient-define-prefix org-sm-transient-map()
    ...
    [
     ...
     ["ai"
      ...
      ("w" "workbench: refine/split" org-sm-card-workbench)
      ]
     ]
    ))
#+end_src
