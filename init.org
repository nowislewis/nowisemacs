...
#+begin_src elisp
  ...
  (meow-leader-define-key
   ...
   ;; '("e d" . dtache-action-map) //TODO use global in dtache
   ;; vterm
   '("e v v" . multi-vterm)
   '("e v d" . multi-vterm-dedicated-toggle)
   '("e v n" . multi-vterm-next)
   '("e v p" . multi-vterm-prev)
   '("e v r" . multi-vterm-rename-buffer)
   '("e v s" . multi-vterm-dedicated-select)
   '("e v w" . multi-vterm-project)
   ;; insert-translated
