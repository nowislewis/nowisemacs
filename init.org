...
(defun wsl-copy-region-to-clipboard (start end)
  "Copy region to Windows clipboard and kill-ring."
  (interactive "r")
  ...
  (keymap-global-set "<remap> <kill-ring-save>" #'wsl-copy-region-to-clipboard)
  (keymap-global-set "<remap> <meow-yank>" #'wsl-paste-from-clipboard))
#+end_src
** android
#+begin_src elisp
