...
#+begin_src elisp
  (setup (:pkg company-box)
    ...
    (:options company-box-doc-delay 0.1
...
#+begin_src elisp
	...
	(:autoload "aweshell" aweshell-toggle)
	(:autoload "aweshell" aweshell-dedicated-toggle))
#+end_src
* 编程
** magit
#+begin_src elisp
...
#+begin_src elisp
  (setup (:pkg org-download)
    ...
    (:autoload "org-download" org-download-screenshot)
    )
#+end_src
...
#+begin_src elisp
  (setup (:pkg websocket))
  (setup (:pkg org-roam-ui :host github :repo "org-roam/org-roam-ui"))
#+end_src
* Runtime Performance
