...
#+begin_src elisp
  ...
  (meow-leader-define-key
   ;; youdao
   ;; '("e y p" . youdao-dictionary-search-at-point-posframe)
   ;; '("e y s" . youdao-dictionary-search)
   ;; '("e y i" . youdao-dictionary-search-from-input)
   ;; '("e y r" . youdao-dictionary-search-and-replace)
