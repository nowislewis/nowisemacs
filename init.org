...
(defun nowis-capture-inc ()
  "Copy selection with M-w then capture as org-sm topic.
Explicitly passes the selected text to avoid `gui-get-selection'
decoding it as iso-8859-1 (STRING target) instead of utf-8."
  (interactive)
