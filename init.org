...
#+begin_src elisp
  ...
  (setup (:pkg org-roam)
    (:option org-roam-mode-section-functions (list #'org-roam-backlinks-section
             ...
             org-roam-node-display-template (concat "${type:15} ${doom-hierarchy:95} " (propertize "${tags:*}" 'face 'org-tag))
             org-roam-capture-templates '(("m" "main" plain "%?"
                                          ...
                                          ("r" "reference" plain "%?"
                                           :if-new
                                           (file+head "reference/%<%Y-%m-%d>-${title}.org"
                                                      "#+title: ${title}\n* Action notes\n* Idea notes\n* Sealed notes")
                                           :unnarrowed t)
                                          ("a" "article" plain "%?"
                                           :if-new
                                           (file+head "articles/%<%Y-%m-%d>-${title}.org"
                                                      "#+title: ${title}\n* Action notes\n* Idea notes\n* Sealed notes")
                                           :unnarrowed t)))
    (:when-loaded
