...
** ghostel
#+begin_src elisp
;; meow integration: enter insert state on ghostel buffer entry;
;; normal state → copy-mode, insert state → exit copy-mode
...
;; n/p to navigate prompts in copy-mode (OSC 133)
(with-eval-after-load "ghostel"
  (keymap-set ghostel-copy-mode-map "n" #'ghostel-next-prompt)
  (keymap-set ghostel-copy-mode-map "p" #'ghostel-previous-prompt))
