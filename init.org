...
- [[#org-mode][Org Mode]]
  ...
  - [[#ebib][ebib]]
  - [[#denote][denote]]
  - [[#denote-convert-from-org-roam][denote-convert-from-org-roam]]
- [[#翻译][翻译]]
...
#+begin_src elisp
  ...
  ;; (require 'denote)
  ;; (find-dir "~/Documents/emacs/orgmode/denote/" "-ls")
  (defun find-denote-file-dir()
    (interactive)
    ;; (find-name-dired "~/Documents/emacs/orgmode/denote/" "*.org")
    (dirvish-dwim "~/Documents/emacs/orgmode/denote/")
    ;; (find-file "~/Documents/emacs/orgmode/denote/")
    )
