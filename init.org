...
(setup org-fc
  ...
  ;; autoload some useful commands
  (defun load-org-fc (orig-fun &rest args)
    (if (not (featurep 'org-fc))
        (require 'org-fc)))

  (:autoload org-fc-dashboard
             org-fc-dashboard
  ...
  (dolist (func (list
                 ...
                 ;; 'org-fc-type-normal-init
                 'org-fc-type-text-input-init))
    (advice-add func :before #'load-org-fc))

  (defun insert-hello-world-under-content-headings ()
  "Insert 'hello world' under all 'Content' headings in the current buffer."
  (interactive)
  (save-excursion
    (goto-char (point-min))
