...
- [[#org-mode][Org Mode]]
  ...
  - [[#org-roam][org-roam]]
  - [[#ox-hugo][ox-hugo]]
  - [[#org-elp-for-latex-live-preview][org-elp for latex live preview]]
  - [[#org-clock][org-clock]]
  - [[#org-noter][org-noter]]
...
#+begin_src elisp
  (defun lewis/meow-append()
       (interactive)
       (progn (meow-line 1)
              (meow-append)))
  (defun lewis/meow-insert()
       (interactive)
       (progn (meow-join 1)
              (meow-append)))
#+end_src
...
#+begin_src elisp
  ...
  ;; 英文等宽字体(无需中英文对齐)
  ;; (dolist (fixed-en-face '(org-level-1
  ;;                          ))
  ;;   (add-to-list fixed-en-face mixed-pitch-fixed-pitch-faces))
  ;;   (add-to-list line-number mixed-pitch-fixed-pitch-faces)
...
#+begin_src elisp
  ...
  (setup org-roam
    (:option
     ...
     org-roam-dailies-directory (concat nowisemacs-doc-root-dir "/orgmode/roam/")
