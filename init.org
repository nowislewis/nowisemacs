...
(transient-define-prefix notes-leader-map()
  ...
  [["Roam"
   ...
   ["org-mind-map"
    ...
    ("M" "org-mind-map" org-mind-map-write-current-tree)]
   ]
  )
#+end_src
*** search
...
(transient-define-prefix apps-leader-map()
  ...
  [["agenda"
   ...
   ;;  ]
   ["shell"
    ;; ("i" "toggle-insert-cd" eat-toggle-insert-cd)
    ]
   ["mpvi"
    ("mo" "open" mpvi-open)
    ("ms" "seek" mpvi-seek)
...
(setup dired-preview
  (setq dired-preview-delay 0.5
        dired-preview-trigger-commands '(dired-previous-line dired-next-line)
        )
