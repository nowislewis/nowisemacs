...
#+begin_src elisp
  (setup rime
    (:option rime-disable-predicates '(meow-normal-mode-p
             ...
             rime-show-candidate 'minibuffer ;;posframe not work well in wsl2
...
** my-gtd
#+begin_src elisp
    (defun my-gtd-refile-q2abc()
      (interactive)
      (org-todo)
      (org-refile))

    (defun my-gtd-refile-q3b()
      (interactive)
      (org-todo "NEXT")
      (org-set-tags "2mins")
      (org-refile)
    ...
    (defun my-gtd-refile-q4a()
      (interactive)
      (org-todo "PROJECT")
      (org-set-tags "Project")
      (org-refile)
      )
    (defun my-gtd-refile-q5a()
      (interactive)
      (org-todo "NEXT")
      (org-refile)
      )
    (defun my-gtd-refile-q5b()
      (interactive)
      (org-todo "WAIT")
      (org-refile)
      )
    ...
    (transient-define-prefix my-gtd-q3-commands()
      [["2 分钟内能做完"
        ("n" "不能做完" my-gtd-q4-commands)
        ("y" "可以做完" my-gtd-refile-q3b)
        ]])

    (transient-define-prefix my-gtd-q4-commands()
      [["能否一步完成"
        ("y" "yes 可以" my-gtd-q5-commands)
        ("n" "no 不能, 是 project" my-gtd-refile-q4a)
        ]])

    (transient-define-prefix my-gtd-q5-commands()
      [[" 自己做或者等别人做"
        ("y" "yes 自己做" my-gtd-refile-q5a)
        ("n" "no 等别人" my-gtd-refile-q5b)
        ]])


    (transient-define-prefix my-gtd-q2-commands()
      ["现阶段考虑做"
       ("y" "yes" my-gtd-q3-commands)
       ("n" "no,Someday or need collected" my-gtd-refile-q2abc)
       ]
      )

  ;; ;; TODO use a single transient command
  ;; (transient-define-prefix my-org-gtd-choose ()
