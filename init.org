  ...
  (transient-define-prefix leader-map-for-notes()
    ...
    [["Org Roam Basic"
     ...
     ["Org Roam daily"
      ...
      ["Zettel-desk"
       ("m" "Zetteldesk mode" zetteldesk-mode)
       ("z" "zetteldesk" zetteldesk-keybindings)]])
#+end_src
*** zetteldesk-keybindings
#+begin_src elisp
  (transient-define-prefix zetteldesk-keybindings
    "Transient keymap for zetteldesk"
    [["Add to Zetteldesk"
      ("an" "Add Node" zetteldesk-add-node-to-desktop)
      ("ab" "Add Node + All its backlinks" zetteldesk-add-backlinks-to-desktop)
      ("ap" "Add one of its backlinks" zetteldesk-add-poi-or-moc-backlink-to-desktop)
      ("aa" "Add Buffer" zetteldesk-add-to-desktop)]
     ["Remove from Zetteldesk"
      ("rn" "Remove Node" zetteldesk-remove-node-from-desktop)
      ("rb" "Remove Node + All its backlinks" zetteldesk-remove-backlinks-from-desktop)
      ("rr" "Remove from desktop" zetteldesk-remove-from-desktop)]
     ["Insert from zetteldesk"
      ("in" "Node and Contents" zetteldesk-insert-node-contents)
      ("iN" "Node Contents without link" zetteldesk-insert-node-contents-without-link)
      ("ii" "Link to Node" zetteldesk-node-insert)
      ("ib" "Insert sort backlinks" zetteldesk-node-insert-sort-backlinks)
      ("im" "Links to all POIs and MOCs" zetteldesk-node-insert-if-poi-or-moc)
      ("ip" "Link to PDF" zetteldesk-insert-link-to-pdf)
      ("io" "Org File Contents" zetteldesk-insert-org-file-contents)]
     ["Main funtion"
      ("b"  "Switch to Zetteldesk Buffer" zetteldesk-switch-to-buffer)
      ("n"  "Find Zetteldesk Node" zetteldesk-node-find)
      ("s"  "Switch to scratch buffer" zetteldesk-switch-to-scratch-buffer)]
     ])
#+end_src
** meow leader keys
#+begin_src elisp
