...
(setup windmove
  (transient-define-prefix windmove-transient-keybindings()
    ...
    (:global [remap other-window] #'windmove-transient-keybindings)
  )
...
#+begin_src elisp
  (setup dirvish
    ...
    (:option dirvish-attributes '(subtree-state)
...
#+begin_src elisp
  (setup sdcv
    (:option sdcv-dictionary-data-dir (file-truename (concat nowis-doc-emacs-dir "02-binary-files/03-stardicts/"))
...
(defun lewis-backup-to-nas-restic()
  (interactive)
  (async-shell-command "restic -r sftp:lewis-nas@192.168.31.108:/share/my_webdav/restic backup ~/Documents/emacs/02-binary-files/")
  )
(defun lewis-backup-to-nas-tmp-file()
  (interactive)
  (async-shell-command "rsync -avi --delete ~/Downloads/tmp/ lewis-nas@192.168.31.108:/share/my_webdav/rsync/tmp/")
  )

(defun lewis-backup-from-nas-tmp-file()
  (interactive)
  (async-shell-command "rsync -avi --delete lewis-nas@192.168.31.108:/share/my_webdav/rsync/tmp/ ~/Documents/emacs/02-binary-files/02-searchable/ ")
  )
