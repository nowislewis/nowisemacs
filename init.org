...
#+begin_src elisp
  (setup consult-notes
    (:option consult-notes-sources
             '(("Xnotes"             ?x "~/Documents/emacs/orgmode/xnotes")
               ("Papers"      ?p "~/Documents/emacs/orgmode/papers"))
...
#+begin_src elisp
  ...
  (setup pyim
    (:option pyim-cloudim 'baidu
             ...
             pyim-dcache-directory (concat nowisemacs-doc-other-files-dir "pyim/dcache/"))
    (:when-loaded
      (require 'popup nil t)
          ...
          (transient-define-prefix leader-map-for-tabspaces()
            ...
            [["Create or close"
             ...
             ["Switch tab bar by index"
              ...
              ("5" "tab-bar-select-tab-6th" tab-bar-select-tab-6th)
              ("5" "tab-bar-select-tab-7th" tab-bar-select-tab-7th)
              ]
             ]
            )
          ))
...
#+begin_src elisp
  (setup aggresive-indent
    (:defer (global-aggressive-indent-mode)))
#+end_src
* Org Mode
** org-mode
#+begin_src elisp
...
#+begin_src elisp
  ...
  (defun lewis-search-last-week()
    "show any entry with a timestamp"
    (interactive)
...
#+begin_src elisp
  (setup elfeed
    (:option
     ;; elfeed-feeds '("http://ruzkuku.com/all.atom"
